...
flags.DEFINE_string('video', './data/video/Schräg-140-60.mov', 'path to input video or set to 0 for webcam') #'./data/video/test.mp4'
flags.DEFINE_string('output', './data/video/Test_20210329-1.mpeg', 'path to output video')
...
pts = [deque(maxlen=30000) for _ in range(50000)]
...
def main(_argv):
    ...
    while True:
        ...
        if return_value:
            ...
            frame = frame[500:1500,2000:3000]
