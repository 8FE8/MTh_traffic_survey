...
flags.DEFINE_string('video', './data/video/DJI_0005.mov', 'path to input video or set to 0 for webcam') #'./data/video/test.mp4'
...
def main(_argv):
    ...
    while True:
        ...
        if return_value:
            ...
            #frame = frame[1000:1500,1000:1500]
